...
import AdvancedImageReveal from '@/components/animation/AdvancedImageReveal';
    ...
    <main className="overflow-hidden">
      ...
      <section data-scroll-section className="section-padding bg-gray-50 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12">
          ...
          {/* Centered container for services */}
          ...
          <div className="text-center mb-16">
            ...
            <div className="flex justify-center">
              <motion.p
                ...
                className="text-gray-600 text-lg text-center leading-relaxed max-w-2xl"
              >
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 justify-items-center">
              <ScrollReveal direction="left" delay={0.1}>
                <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-shadow cursor-hover text-center" data-cursor-text="Learn">
              ...
              <ScrollReveal direction="up" delay={0.2}>
                <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-shadow cursor-hover text-center" data-cursor-text="Explore">
                  <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mb-4 mx-auto">
                    <span className="text-3xl">💡</span>
                  </div>
              ...
              <ScrollReveal direction="right" delay={0.3}>
                <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-shadow cursor-hover text-center" data-cursor-text="Discover">
                  <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mb-4 mx-auto">
                    <span className="text-3xl">🤝</span>
                  </div>
